...
const Sidebar = ({ view, setView, setGlobalPlaylistId }) => {
  ...
  return (
    <div className="w-64 text-neutral-400 grow-0 shrink-0 h-screen overflow-y-scroll border-r border-neutral-900 flex flex-col p-5 space-y-4 text-sm hidden md:inline-flex">
